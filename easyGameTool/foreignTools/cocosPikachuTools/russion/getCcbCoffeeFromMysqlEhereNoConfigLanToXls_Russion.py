...
if __name__ == '__main__':
    ccbSql = "SELECT Id,Russion,English from ccbTranslate WHERE Id IS NOT NULL and Id != 0"  # and Vietnamese is not NULL
    coffeeSql = "SELECT Id,Russion,English from coffeeTranslate WHERE Id IS NOT NULL and Id != 0"  # and Vietnamese is not NULL
