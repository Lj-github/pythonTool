...
#工具路径
TOOLSPATH = "/Users/admin/Documents/ljworkspace/local/cocos/test/lan/foreignTools/"
...
excelFiles=[
    ...
    '/Users/admin/Documents/ljworkspace/local/cocos/assets/pikachu/sanguo/aiweiyou_pokmon/pika_foreign/CCBReplaceEnglish_3.xls'
]
...
try:
    ...
    if not isOnlyTranslateCCB:
        ...
        '''目的文件'''
        filepth2 = TOOLSPATH #'/Users/lan/resBin/english/'
        ...
        os.system('sh '+ TOOLSPATH +' make_all_plist_en.sh')
        print('font资源替换完毕')
