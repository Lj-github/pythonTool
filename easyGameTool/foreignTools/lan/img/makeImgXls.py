...
resdirList  = [
    [
        '/Users/admin/Documents/ljworkspace/local/cocos/assets/pikachu/sanguo/aiweiyou_pokmon/EnglishResources/绿洲翻译/18年7月',
        '/Users/admin/Documents/ljworkspace/local/cocos/assets/pikachu/sanguo/aiweiyou_pokmon/EnglishResources/绿洲翻译/18年8月',
        '/Users/admin/Documents/ljworkspace/local/cocos/assets/pikachu/sanguo/aiweiyou_pokmon/EnglishResources/绿洲翻译/18年9月',
    ],
    [],
    [],
    [],
...
titleList = ['fileName','English','Russion','Vietnam','French','Germany']

imgTranslateXlsPth='/Users/admin/Desktop/translateImgData.xls'
    ...
    for root, dirs, files in os.walk(srcDir):
            for OneFileName in files:
                ...
                if fileType in keyNameType:
                    ...
                    if (imgMap.get(nameNoneType + '.png')):
                        imgMap[nameNoneType + '.png'][translateId] = lines
                    elif (imgMap.get(nameNoneType + '.jpg')):
