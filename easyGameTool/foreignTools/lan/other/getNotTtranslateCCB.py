...
replaceFile = '/Users/lan/Downloads/历次翻译整理/整理汇总翻译/CCBReplaceEnglish_最终.xls'
replaceFile = '/Users/lan/sanguo/aiweiyou_pokmon/pika_foreign/ccbTranslate.xls'
...
def parse_node(node, name):
    ...
    for child in node:
        if child.tag == 'key' and child.text == 'baseClass':
            isLabelName = 1
        elif isLabelName ==1 and child.tag == 'string' and (child.text == 'CCLabelTTF' or child.text == 'CCLabelBMFont'):
            isLabelName = 2
    ...
    for i in range(nrows):
        ...
        for j in range(ncols):
            ...
            if objTranslatePth != None and isFindTranslate != 1:
                ...
                makeXlsIdMap(filepth,str(cell_value), int(_id))
...
def writeIdMap():
    ...
    for fileName, fileMap in nodeIdMap.items():
        ccbLblXlsPth = '/Users/lan/Downloads/Language/英文/ccbLbl/'+fileName.split('.')[0]+'.xls'
