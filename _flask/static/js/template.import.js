...
var beginLoadTools = function () {
    ...
    //     str = ""
    // }
    // gt.loadSingleScript(str+"js/com/UnitTools.js",function () {
    //     gt.loadSingleScript(str+"js/com/Const.js",function () {
    //         gt.loadSingleScript(str+"js/com/LocalContext.js",function () {
    //              if(App.IS_NEED_CONSOLE){
    //             gt.loadSingleScript(str+App.eruda,function () {runMain()})
    //         }else {runMain()}
    //         })
    //         /**
    //          * 所有逻辑放在其他文件中  因为每次发布 布局文件  js 会被覆盖  必须在view 新建对应的 js 文件  默认加载
    //          * */
    //     })
    // })
